            ...
            switch (figura) {
                ...
                case "rectangle":
                    ...
                    try {
                        ...
                        Figures nouRect = new Rectangle(x, y, w, h, this.getColor(color));
                    ...
                    break;
                case "cuadrat":
                    // Creació d'una figura de la classe cuadrat
                    try {
                        // Extraiem les dimensions
                        int x = Integer.parseInt((components[1]));
                        int y = Integer.parseInt((components[2]));
                        ...
                        // Si tot és correcte creem la figura cuadrat
                        Figures nouCua = new Cuadrat(x, y, w, this.getColor(color));
                        // I l'afegim a la llista
                        AppEscena.add(nouCua);

                    } catch (Exception e) {
                        // Si s'ha produït algun error als paràmetres, s'indica un error de sintaxi
                        System.out.println(
                                "\u001B[31m Error de sintaxi. La sintaxi correcta és:\ncuadrat x y width color\u001B[0m");
                    }
                    ;
                    break;    
                case "cercle":
                    ...
                    try {
                        ...
                        // Si tot és correcte creem la figura cercle
                        Figures nouCer = new Cercle(x, y, w, this.getColor(color));
                        // I l'afegim a la llista
                ...
                case "elipsis":
                    ...
                    try {
                        ...
                        // Si tot és correcte creem la figura elipsis
                        Figures nouEli = new Elipsis(x, y, w, h, this.getColor(color));
                        // I l'afegim a la llista
                        ...
                        // Si s'ha produït algun error als paràmetres, s'indica un error de sintaxi
                        System.out.println(
                                "\u001B[31m Error de sintaxi. La sintaxi correcta és:\nelipsis x y width height color\u001B[0m");
                    }
                    ;
                    break;
                case "linia":
                    // Creació d'una figura de la classe linia
                    try {
                        // Extraiem les dimensions
                        int x = Integer.parseInt((components[1]));
                        int y = Integer.parseInt((components[2]));
                        ...
                        // Si tot és correcte creem la figura elipsis
                        Figures nouLin = new linia(x, y, x2, y2, this.getColor(color));
                        // I l'afegim a la llista
